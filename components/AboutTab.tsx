    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div>
        ...
        <div className="space-y-4 text-sm text-zinc-400 leading-relaxed mb-6">
          ...
          <p>
            While the CVSS vector provides rich information, many applications
            only report the CVSS score. The goal of VulnSig is to make
            vulnerability characteristics beyond just severity immediately
            legible.
          </p>
          <p>
            VulnSig supports CVSS 4.0, 3.1, 3.0, and 2.0. It is freely available
            in TypeScript, Python, and Rust libraries, as well as in a React
            component (used to build this site), and a REST API that delivers
            SVGs and PNGs.
          </p>
          <p>
            VulnSig was created by{" "}
            <ExternalLink href="https://www.flexatone.net">
              Christopher Ariza
            </ExternalLink>{" "}
