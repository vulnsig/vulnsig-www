  ...
  return (
    <div className="space-y-10">
      ...
      <LegendSection
        title="Star Points"
        metricKeys={["AV"]}
        description={<>Attack Vector describes how the vulnerability is exploited. <ValueTag label="N" /> Network means remote exploitation — 8 points. <ValueTag label="A" /> Adjacent requires local network access — 6 points. <ValueTag label="L" /> Local needs OS-level access — 4 points. <ValueTag label="P" /> Physical requires touching the device — 3 points.</>}
        examples={[
      ...
      <LegendSection
        ...
        metricKeys={["AC"]}
        description={<>Attack Complexity reflects conditions beyond the attacker&apos;s control. <ValueTag label="L" /> Low produces sharp star points — exploitation is straightforward. <ValueTag label="H" /> High produces blunt, rounded points — specific conditions must align.</>}
        examples={[
      ...
      <LegendSection
        title="Star Outline"
        metricKeys={["PR"]}
        description={<>Privileges Required describes the level of access needed before exploitation. <ValueTag label="N" /> None shows a thin outline — no authentication needed. <ValueTag label="L" /> Low shows a medium stroke. <ValueTag label="H" /> High shows a thick outline — significant privileges required.</>}
        examples={[
      ...
      <LegendSection
        ...
        metricKeys={["VC", "VI", "VA"]}
        description={<>The ring is divided into three sectors for Confidentiality, Integrity, and Availability. <ValueTag label="H" /> High lights a sector brightly, <ValueTag label="L" /> Low dims it, and <ValueTag label="N" /> None leaves it dark.</>}
        examples={[
          ...
          { label: "All None", vector: "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:N/VI:N/VA:N/SC:N/SI:N/SA:N", score: 9.3 },
        ]}
      />
      ...
      <LegendSection
        ...
        metricKeys={["AT"]}
        description={<>Attack Requirements captures prerequisites in the vulnerable system&apos;s environment. <ValueTag label="P" /> Present segments the ring with visible cuts. <ValueTag label="N" /> None keeps the ring smooth and continuous.</>}
        examples={[
      ...
      <LegendSection
        ...
        metricKeys={["UI"]}
        description={<>User Interaction describes whether someone other than the attacker must participate. <ValueTag label="N" /> None produces spikes — fires autonomously. <ValueTag label="P" /> Passive shows bumps — encountered during normal use. <ValueTag label="A" /> Active produces a smooth edge — deliberate action required.</>}
        examples={[
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-zinc-300">
              <tr className="border-b border-zinc-800/50">
                ...
                <td className="py-2 pr-4"><MetricTag label="AV" color={metricColor("AV")} /></td>
                <td className="py-2 text-zinc-400">8=<ValueTag label="N" /> 6=<ValueTag label="A" /> 4=<ValueTag label="L" /> 3=<ValueTag label="P" /></td>
              </tr>
              <tr className="border-b border-zinc-800/50">
                <td className="py-2 pr-4">Star pointiness</td>
                <td className="py-2 pr-4"><MetricTag label="AC" color={metricColor("AC")} /></td>
                <td className="py-2 text-zinc-400">Sharp=<ValueTag label="L" /> Blunt=<ValueTag label="H" /></td>
              </tr>
              <tr className="border-b border-zinc-800/50">
                <td className="py-2 pr-4">Star outline</td>
                <td className="py-2 pr-4"><MetricTag label="PR" color={metricColor("PR")} /></td>
                <td className="py-2 text-zinc-400">Thin=<ValueTag label="N" /> Medium=<ValueTag label="L" /> Thick=<ValueTag label="H" /></td>
              </tr>
              <tr className="border-b border-zinc-800/50">
                <td className="py-2 pr-4">Spikes / bumps</td>
                <td className="py-2 pr-4"><MetricTag label="UI" color={metricColor("UI")} /></td>
                <td className="py-2 text-zinc-400">Spikes=<ValueTag label="N" /> Bumps=<ValueTag label="P" /> Smooth=<ValueTag label="A" /></td>
              </tr>
              <tr className="border-b border-zinc-800/50">
                <td className="py-2 pr-4">Ring segmentation</td>
                <td className="py-2 pr-4"><MetricTag label="AT" color={metricColor("AT")} /></td>
                <td className="py-2 text-zinc-400">Solid=<ValueTag label="N" /> Segmented=<ValueTag label="P" /></td>
              </tr>
              <tr className="border-b border-zinc-800/50">
                <td className="py-2 pr-4">Ring brightness</td>
                <td className="py-2 pr-4 space-x-1"><MetricTag label="VC" color={metricColor("VC")} /><MetricTag label="VI" color={metricColor("VI")} /><MetricTag label="VA" color={metricColor("VA")} /></td>
                <td className="py-2 text-zinc-400">Bright=<ValueTag label="H" /> Dim=<ValueTag label="L" /> Dark=<ValueTag label="N" /></td>
              </tr>
              <tr className="border-b border-zinc-800/50">
                <td className="py-2 pr-4">Split band</td>
                <td className="py-2 pr-4 space-x-1"><MetricTag label="SC" color={metricColor("SC")} /><MetricTag label="SI" color={metricColor("SI")} /><MetricTag label="SA" color={metricColor("SA")} /></td>
                <td className="py-2 text-zinc-400">Split when any &gt; <ValueTag label="N" /></td>
              </tr>
              <tr>
